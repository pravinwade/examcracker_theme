...
/*************************************************************
 *
 *  MathJax/jax/output/HTML-../Content/css/config.js
 *  
 *  Initializes the HTML-CCS OutputJax  (the main definition is in
 *  MathJax/jax/input/HTML-../Content/css/jax.js, which is loaded when needed).
 *
 *  ---------------------------------------------------------------------
 *  
...
MathJax.OutputJax["HTML-CSS"] = MathJax.OutputJax({
  ...
  autoloadDir: MathJax.OutputJax.directory + "/HTML-../Content/css/autoload",
  fontDir: MathJax.OutputJax.directory + "/HTML-../Content/css/fonts", // font name added later
